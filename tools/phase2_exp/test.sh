...
do
    ...
    do
        ...
        python test.py ../config/phase2/${model}_test.py ../work_dirs/phase2/${model}/${method}/${lr_array[$i]}/epoch_"$epoch".pth --work-dir ../work_dirs/phase2/${model}/test/${method}/${lr_array[$i]}/epoch_"$epoch"
