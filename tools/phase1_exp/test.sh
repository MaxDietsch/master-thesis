...
do 
    ...
    do
        ...
        python test.py ../config/phase_1/${model}_test.py ../work_dirs/phase_1/${model}/${lr_array[$i]}/epoch_"$epoch".pth --out ../work_dirs/phase_1/${model}/test/${lr_array[$i]}/epoch_"$epoch" --out-item metrics
    done
done
