...
do 
    ...
    do
        ...
        python analysis_tools/confusion_matrix.py ../config/phase3/${model}_test.py ../work_dirs/phase3/${model}/${method}/${lr_array[$i]}/epoch_"$epoch".pth --show-path ../work_dirs/phase3/${model}/test/${method}/${lr_array[$i]}/cm/conf_matrix_epoch_"$epoch"
