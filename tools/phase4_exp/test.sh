...
method="pretrained_relative_loc"
...
do
    ...
    do
        ...
        python test.py ../config/phase2/${model}_test.py ../work_dirs/phase4/${model}/${method}/${lr_array[$i]}/epoch_"$epoch".pth --work-dir ../work_dirs/phase4/${model}/test/${method}/${lr_array[$i]}/epoch_"$epoch"
